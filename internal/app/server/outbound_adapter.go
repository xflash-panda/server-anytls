...
// UDPConn is the UDP connection interface.
...
// the Outbound interface expected by outbound_tcp.go functions.
...
func (a *OutboundAdapter) UDP(addr string) (UDPConn, error) {
	...
	return &udpConnWrapper{conn: uc}, nil
}

// udpConnWrapper wraps acl-engine's UDPConn to provide our UDPConn interface.
